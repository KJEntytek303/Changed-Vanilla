...
public class ChangedVanillaEntityRenderers {
    ...
    public static void registerEntityRenderers(EntityRenderersEvent.RegisterRenderers event) {
        ...
        ChangedEntityRenderers.registerHumanoid(event, ChangedVanillaEntities.LATEX_CHICKEN.get(), LatexChickenRenderer::new);
        ...
        ChangedEntityRenderers.registerHumanoid(event, ChangedVanillaEntities.LATEX_PIG.get(), LatexPigRenderer::new);
        ...
        ChangedEntityRenderers.registerHumanoid(event, ChangedVanillaEntities.LATEX_ZOMBIE.get(), LatexZombieRenderer::new);
    }
}
