...
public class LatexSheepModel extends AdvancedHumanoidModel<LatexSheep> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ChangedVanilla.modResource("latex_sheep"), "main");
    ...
    private final HumanoidAnimator<LatexSheep, LatexSheepModel> animator;

    public LatexSheepModel(ModelPart root) {
        super(root);
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition cube_r1 = LeftEar.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(0, 69).addBox(-1.0F, -3.5F, -1.75F, 2.0F, 6.0F, 3.0F, new CubeDeformation(0.0F))
                .texOffs(10, 69).addBox(-1.0F, -3.5F, -1.75F, 2.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.525F, 1.55F, 0.0F, 0.3979F, -0.5926F, -1.1729F));

        PartDefinition RightEar = Head.addOrReplaceChild("RightEar", CubeListBuilder.create(), PartPose.offset(-4.0F, -6.0F, 0.5F));

        PartDefinition cube_r2 = RightEar.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(10, 69).mirror().addBox(-1.0F, -3.5F, -1.75F, 2.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(0, 69).mirror().addBox(-1.0F, -3.5F, -1.75F, 2.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-1.525F, 1.55F, 0.0F, 0.3979F, 0.5926F, 1.1729F));
        ...
        PartDefinition Torso = partdefinition.addOrReplaceChild("Torso", CubeListBuilder.create().texOffs(32, 0).addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(20, 67).addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.25F)), PartPose.offset(0.0F, -0.5F, 0.0F));
    ...
    @Override
    public HumanoidAnimator<LatexSheep, LatexSheepModel> getAnimator(LatexSheep entity) {
        return animator;
    }
}
