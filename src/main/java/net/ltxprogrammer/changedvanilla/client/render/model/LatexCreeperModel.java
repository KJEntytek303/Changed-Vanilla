...
public class LatexCreeperModel extends AdvancedHumanoidModel<LatexCreeper> implements LowerTorsoedModel {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ChangedVanilla.modResource("latex_creeper"), "main");
    ...
    private final HumanoidAnimator<LatexCreeper, LatexCreeperModel> animator;

    public LatexCreeperModel(ModelPart root) {
        super(root);
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition Head = partdefinition.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(36, 25).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F))
                .texOffs(21, 45).addBox(-2.0F, -3.0F, -5.0F, 4.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -1.5F, -7.0F));
        ...
        PartDefinition cube_r1 = LeftEar.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(0, 83).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.475F, 2.55F, 0.0F, 0.4287F, 0.4011F, 0.1766F));

        PartDefinition RightEar = Head.addOrReplaceChild("RightEar", CubeListBuilder.create(), PartPose.offset(-4.0F, -6.0F, 0.5F));

        PartDefinition cube_r2 = RightEar.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(0, 83).mirror().addBox(-1.0F, -1.0F, -1.0F, 2.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.475F, 2.55F, 0.0F, 0.4287F, -0.4011F, -0.1766F));
        ...
        PartDefinition Torso = partdefinition.addOrReplaceChild("Torso", CubeListBuilder.create().texOffs(0, 45).addBox(-4.0F, 0.0F, -2.0F, 8.0F, 10.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(14, 78).addBox(-4.0F, 0.0F, -2.0F, 8.0F, 10.0F, 4.0F, new CubeDeformation(0.25F)), PartPose.offset(0.0F, -1.5F, -7.0F));
        ...
        PartDefinition LeftLeg2 = LowerTorso.addOrReplaceChild("LeftLeg2", CubeListBuilder.create(), PartPose.offsetAndRotation(3.5F, 0.0F, 15.875F, -0.3491F, 0.0F, 0.0F));
        ...
        PartDefinition RightLeg2 = LowerTorso.addOrReplaceChild("RightLeg2", CubeListBuilder.create(), PartPose.offsetAndRotation(-3.5F, 0.0F, 16.375F, 0.3491F, 0.0F, 0.0F));
        ...
        PartDefinition LeftLeg = LowerTorso.addOrReplaceChild("LeftLeg", CubeListBuilder.create(), PartPose.offsetAndRotation(3.5F, 0.0F, -1.7F, 0.3491F, 0.0F, 0.0F));
        ...
        PartDefinition RightLeg = LowerTorso.addOrReplaceChild("RightLeg", CubeListBuilder.create(), PartPose.offsetAndRotation(-4.0F, 0.0F, -1.7F, -0.3491F, 0.0F, 0.0F));
        ...
        PartDefinition RightArm = partdefinition.addOrReplaceChild("RightArm", CubeListBuilder.create().texOffs(0, 0).addBox(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(57, 77).addBox(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.25F)), PartPose.offsetAndRotation(-5.0F, 0.5F, -7.0F, 0.2618F, 0.0F, 0.2618F));

        PartDefinition LeftArm = partdefinition.addOrReplaceChild("LeftArm", CubeListBuilder.create().texOffs(39, 55).addBox(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(73, 77).addBox(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.25F)), PartPose.offsetAndRotation(5.0F, 0.5F, -7.0F, -0.2618F, 0.0F, -0.2618F));
    ...
    @Override
    public HumanoidAnimator<LatexCreeper, LatexCreeperModel> getAnimator(LatexCreeper entity) {
        return animator;
    }
