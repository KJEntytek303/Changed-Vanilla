...
public class LatexCowModel extends AdvancedHumanoidModel<LatexCow> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ChangedVanilla.modResource("latex_cow"), "main");
    ...
    private final HumanoidAnimator<LatexCow, LatexCowModel> animator;

    public LatexCowModel(ModelPart root) {
        super(root);
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition Head = partdefinition.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F))
                .texOffs(57, 9).addBox(-2.0F, -3.0F, -6.0F, 4.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -0.5F, 0.0F));

        PartDefinition Horns = Head.addOrReplaceChild("Horns", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, -8.0F, -2.0F, -0.6545F, 0.0F, 0.0F));

        PartDefinition Head_r1 = Horns.addOrReplaceChild("Head_r1", CubeListBuilder.create().texOffs(0, 16).mirror().addBox(-0.5F, -1.5F, -0.5F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.25F)).mirror(false), PartPose.offsetAndRotation(-3.5F, -1.5F, 0.5F, 0.0F, 0.0F, -0.2618F));

        PartDefinition Head_r2 = Horns.addOrReplaceChild("Head_r2", CubeListBuilder.create().texOffs(4, 16).addBox(-0.5F, -1.5F, -0.5F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.25F)), PartPose.offsetAndRotation(3.5F, -1.5F, 0.5F, 0.0F, 0.0F, 0.2618F));
        ...
        PartDefinition cube_r1 = LeftEar.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(10, 69).addBox(-1.0F, -3.5F, -1.75F, 2.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.525F, 1.55F, 0.0F, 0.3979F, -0.5926F, -1.1729F));

        PartDefinition RightEar = Head.addOrReplaceChild("RightEar", CubeListBuilder.create(), PartPose.offset(-4.0F, -6.0F, 0.5F));

        PartDefinition cube_r2 = RightEar.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(0, 69).mirror().addBox(-1.0F, -3.5F, -1.75F, 2.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-1.525F, 1.55F, 0.0F, 0.3979F, 0.5926F, 1.1729F));
        ...
        PartDefinition Base_r1 = TailPrimary.addOrReplaceChild("Base_r1", CubeListBuilder.create().texOffs(0, 78).addBox(-1.5F, 0.921F, -0.8699F, 3.0F, 5.0F, 3.0F, new CubeDeformation(-0.05F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 1.0908F, 0.0F, 0.0F));

        PartDefinition TailSecondary = TailPrimary.addOrReplaceChild("TailSecondary", CubeListBuilder.create(), PartPose.offset(0.0F, 1.25F, 4.5F));

        PartDefinition Base_r2 = TailSecondary.addOrReplaceChild("Base_r2", CubeListBuilder.create().texOffs(33, 68).addBox(-1.5F, -0.2064F, -1.3981F, 3.0F, 6.0F, 3.0F, new CubeDeformation(-0.15F)), PartPose.offsetAndRotation(0.0F, 0.5F, 0.0F, 1.3526F, 0.0F, 0.0F));
        ...
        PartDefinition Base_r3 = TailTertiary.addOrReplaceChild("Base_r3", CubeListBuilder.create().texOffs(20, 73).addBox(-1.5F, 5.0108F, -2.2985F, 3.0F, 4.0F, 3.0F, new CubeDeformation(-0.35F)), PartPose.offsetAndRotation(0.0F, -0.25F, -4.5F, 1.5184F, 0.0F, 0.0F));

        PartDefinition TailQuaternary = TailTertiary.addOrReplaceChild("TailQuaternary", CubeListBuilder.create(), PartPose.offset(0.0F, 1.0F, 4.5F));

        PartDefinition Base_r4 = TailQuaternary.addOrReplaceChild("Base_r4", CubeListBuilder.create().texOffs(21, 66).addBox(-1.5F, 4.7418F, -2.8381F, 3.0F, 4.0F, 3.0F, new CubeDeformation(0.13F)), PartPose.offsetAndRotation(0.0F, -1.0F, -5.5F, 1.6581F, 0.0F, 0.0F));
    ...
    @Override
    public HumanoidAnimator<LatexCow, LatexCowModel> getAnimator(LatexCow entity) {
        return animator;
    }
}
